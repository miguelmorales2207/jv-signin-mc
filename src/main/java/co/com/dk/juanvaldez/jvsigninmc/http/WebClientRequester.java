...
public class WebClientRequester {
    ...
    /*private co.com.dk.juanvaldez.jvsigninmc.data.domain.requestUser.User getAuthenticatedUser() {
        ...
        return modelMapper
            .map(userSecurity, co.com.dk.juanvaldez.jvsigninmc.data.domain.requestUser.User.class);
    }*/
